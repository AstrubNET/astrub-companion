#!/usr/bin/env python3
"""Astrub Companion: passive and anonymous Dofus HDV price collector."""
...
APP_DIR = Path("/Library/Application Support/Astrub Companion")
        ...
        while True:
            ...
            request = urllib.request.Request(
                ...
                headers={
                    ...
                    "User-Agent": "Astrub-Companion-macOS/1.1.3",
                },
            )
            try:
...
def run(config):
    ...
    command = ["/usr/sbin/tcpdump", "-i", interface, "-nn", "-s", "0", "-U", "-w", "-", "tcp port 5555"]
    logging.info("Écoute passive démarrée sur %s", interface)
